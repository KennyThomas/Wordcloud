...
public class Menu extends Abstract{
	...
	public  void display() throws Exception {
		...
		System.out.println("Option 3| enter number of words to display");                     //was not able to stop the menu repeating twice in the menu for option 3 and option 5 
		System.out.println("option 4| enter image name");                                     //all function work 
		System.out.println("option 5| quit");
		option = reader.nextLine();
		}
